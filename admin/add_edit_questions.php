                ...
                <div class="row">
                    ...
                    <div class="card">
                        <div class="card-header"><strong>Add New Questions with Text</strong>
                         ...
                         <div class="card-body card-block">
                             ...
                             class=" form-control-label">Add Question</label><input type="text" name="question" placeholder="Add Question" class="form-control"></div>
                             <div class="form-group"><label for="company" 
                             class="form-control-label">Add Option1</label><input type="text" placeholder="Add Option1" class="form-control" name="opt1"></div>
                             <div class="form-group"><label for="company" 
                             class="form-control-label">Add Option2</label><input type="text" placeholder="Add Option2" class="form-control" name="opt2"></div>
                             <div class="form-group"><label for="company" 
                             class="form-control-label">Add Option3</label><input type="text" placeholder="Add Option3" class="form-control" name="opt3"></div>
                             <div class="form-group"><label for="company" 
                             class="form-control-label">Add Option4</label><input type="text" placeholder="Add Option4" class="form-control" name="opt4"></div>
                             <div class="form-group"><label for="company" 
                             class="form-control-label">Add Answer</label><input type="text" placeholder="Add answer" class="form-control" name="answer"></div>
                    ...
                    <div class="card">
                        <div class="card-header"><strong>Add New Questions with Images</strong>
                         ...
                         <div class="card-body card-block">
                             <div class="form-group"><label for="company" 
                             class=" form-control-label">Add Question</label><input type="text" name="fquestion" placeholder="Add Question" class="form-control"></div>
                             <div class="form-group"><label for="company" 
                             class="form-control-label">Add Opt1</label><input type="file"  class="form-control" name="fopt1" style="padding-bottom:45x"></div>
                             <div class="form-group"><label for="company" 
                             class="form-control-label">Add Opt2</label><input type="file"  class="form-control" name="fopt2" style="padding-bottom:45x"></div>
                             <div class="form-group"><label for="company" 
                             class="form-control-label">Add Opt3</label><input type="file"  class="form-control" name="fopt3" style="padding-bottom:45x"></div>
                             <div class="form-group"><label for="company" 
                             class="form-control-label">Add Opt4</label><input type="file"  class="form-control" name="fopt4" style="padding-bottom:45x"></div>
                             <div class="form-group"><label for="company" 
                             class="form-control-label">Add Answer</label><input type="file"  class="form-control" name="fanswer" style="padding-bottom:45x"></div>
                    ...
                    <div class="col-lg-12">
                      ...
                      <?php
                        ...
                        while ($row=mysqli_fetch_array($res))
                        {
                            ...
                            {
                                ?>
                                <img src="<?php echo $row["opt1"]; ?>" height="100" width="100">
                                <?php
                            ...
                            {
                                ?>
                                <img src="<?php echo $row["opt2"]; ?>" height="100" width="100">
                                <?php
                            ...
                            {
                                ?>
                                <img src="<?php echo $row["opt3"]; ?>" height="100" width="100">
                                <?php
                            ...
                            {
                                ?>
                                <img src="<?php echo $row["opt4"]; ?>" height="100" width="100">
                                <?php
                    ...
                    if(isset($_POST["submit1"]))
                    {
                        ...
                        if($count==0)
                        {
                            ...
                            {
                                $loop=$loop+1;
                                mysqli_query($link,"update questions set question='$loop' where id=$row[id]");
                            }
