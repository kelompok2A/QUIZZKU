...
<body>
                    ...
                    <div class="panel-body">
                        <form action="" name="forml" method="post">
                            ...
                            <div class="alert alert-danger" id="failure" style="margin-top: 10px; display:none">
                                <strong>Can't Login!</strong> Invalid Username or Password
                            </div>
                        </form>
                    </div>
                </div>
    ...
    {
        $count=0;
        $res=mysqli_query($link,"select * from regristration where username='$_POST[username]' && password='$_POST[password]'");
